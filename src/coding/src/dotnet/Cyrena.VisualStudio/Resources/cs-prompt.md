...
- Per-folder AllowedFileTypes flags
...
3. Only then create the file in that folder
...
- All business logic must live in the appropriate service layer as defined by the project structure.
...
8. Verify wiring (dependency injection, service registration).
