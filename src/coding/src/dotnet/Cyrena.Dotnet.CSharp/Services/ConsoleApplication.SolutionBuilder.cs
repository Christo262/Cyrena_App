...
namespace Cyrena.Dotnet.CSharp.Services
{
    internal class ConsoleAppSolutionBuilder : ICodeBuilder
    {
        ...
        public ConsoleAppSolutionBuilder(IServiceProvider services, IKernelController kernel)
        {
            _services = services;
            _kernel = kernel;
        }
        ...
        public Task<DevelopPlan> ConfigureAsync(CyrenaKernelBuilder options)
        {
            ...
            var prompt = Resources.Read(typeof(DotnetExtension).Assembly, "Cyrena.Dotnet.CSharp.Resources.console-app-prompt.md");
