...
namespace Cyrena.Dotnet.CSharp.Services
{
    internal class BlazorAppSolutionBuilder : ICodeBuilder
    {
        ...
        public string Id => BlazorApplication.Id;
        ...
        public async Task<DevelopPlan> ConfigureAsync(CyrenaKernelBuilder options)
        {
            ...
            var prompt = Resources.Read(typeof(DotnetExtension).Assembly, "Cyrena.Dotnet.CSharp.Resources.blazor-app-prompt.md");
        ...
        public async Task EditAsync(ChatConfiguration config, IServiceProvider services)
        {
            ...
            var rf = await dialog.ShowAsync<DotnetCsConfig>("Blazor App", parameters, options);
