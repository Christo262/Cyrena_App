...
{
    internal class ClassLibraryProjectType : IDotnetProjectType
    {
        public string Id => ClassLibrary.Id;
        public string ProjectTypeName => ClassLibrary.Name;
        ...
        public bool IsOfType(ProjectInfo info)
        {
            ...
            try
            {
                ...
                return csproj.SdkType == "Microsoft.NET.Sdk" && csproj.OutputType != "Exe" && csproj.OutputType != "WinExe";
            }
            catch { return false; }
        }
    }
